...
class ControladorPlanMantenimiento{
   ...
   =============================================*/
   public function ctrCrearPlanMantenimiento($request){
      
      if($this->validate($request, ["activoFijo", "fechaInicio", "tipoProgramacion", "responsableMantenimiento", "ubicacionActivo", 
      "numeroSerie", "prioridadMantenimiento", "duracionEstimada", "costoRepuestos", "empresaMantenimiento"])){
