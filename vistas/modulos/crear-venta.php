            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-8 pull-right table-responsive">
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" placeholder="0" value="18" required>
