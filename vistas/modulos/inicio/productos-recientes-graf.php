...
<?php
  ...
  <div class="box box-primary">
      <div class="box-header with-border">
            <h3 class="box-title"><b>5 Servicios más vendidos</b></h3>
      ...
      <div class="box-footer no-padding">
          <div id="reswere" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
