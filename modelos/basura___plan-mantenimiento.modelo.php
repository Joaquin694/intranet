...
class ModeloPlanMantenimiento{
   ...
   public static function mdlIngresarPlanMantenimiento($tabla, $datos){
      ...
      $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(activos_fijos, fecha_inicio, tipo_programacion, responsable_mantenimiento, ubicacion_activo, numero_serie, prioridad_mantenimiento, duracion_estimada, costo_repuestos, empresa_mantenimiento, observaciones, documento) VALUES (:activos_fijos, :fecha_inicio, :tipo_programacion, :responsable_mantenimiento, :ubicacion_activo, :numero_serie, :prioridad_mantenimiento, :duracion_estimada, :costo_repuestos, :empresa_mantenimiento, :observaciones, :documento)");
